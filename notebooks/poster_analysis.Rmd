...
Minimum spanning tree of sequence types, created in Phyloviz[3] with goeBURST distance (TLV). Light blue = Broiler, dark blue = Pig, light green = Red fox, and dark green = Wild bird. Distances between sequence types are denotd as numbers on the lines. 
![](../figures/mlst_tree_full.png)

## Heatmap plot
This plot represents the individual resistance mechanisms (x-axis) present in each isolate (y-axis), for each animal species (colors). Grey squares represent genes/mutations that ARIBA flagged as bad quality in their report. Dark color indicates presence, while the light color indicates absence.
